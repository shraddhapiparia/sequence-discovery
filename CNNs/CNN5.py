...
from keras.layers import Dense, Input, Flatten, Activation, LSTM, Embedding, Conv1D, MaxPooling1D, Conv2D, Convolution1D
...
model_nn = Sequential()
e = Embedding(41,2,input_length = 5, weights=[embedding_matrix], trainable = True)
...
model_nn.add(Conv1D(filters=5, kernel_size=3, activation='relu', padding='valid'))
...
plot_model(model_nn, to_file="CNN5.png", show_shapes=True)
